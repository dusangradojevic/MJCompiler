...
public class ConstructorMethodDeclListConstructor extends ConstructorMethodDeclList {

    private ConstructorDecl ConstructorDecl;

    public ConstructorMethodDeclListConstructor (ConstructorDecl ConstructorDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstructorMethodDeclListConstructor(\n");
