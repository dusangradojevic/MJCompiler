...
public class FormParsOptArgsListAll extends FormParsOptArgsList {

    private FormPars FormPars;
    private OptArgs OptArgs;

    public FormParsOptArgsListAll (FormPars FormPars, OptArgs OptArgs) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormParsOptArgsListAll(\n");
