...
public class VarIdentListDeclared extends VarIdentList {

    private VarIdentList VarIdentList;
    private VarIdent VarIdent;

    public VarIdentListDeclared (VarIdentList VarIdentList, VarIdent VarIdent) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarIdentListDeclared(\n");
