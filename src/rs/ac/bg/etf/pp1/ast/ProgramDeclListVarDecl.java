...
public class ProgramDeclListVarDecl extends ProgramDeclList {

    private ProgramDeclList ProgramDeclList;
    private VarDecl VarDecl;

    public ProgramDeclListVarDecl (ProgramDeclList ProgramDeclList, VarDecl VarDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ProgramDeclListVarDecl(\n");
