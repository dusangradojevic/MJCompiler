...
public class ConstDeclListNext extends ConstDeclList {

    private ConstDeclList ConstDeclList;
    private ConstDef ConstDef;

    public ConstDeclListNext (ConstDeclList ConstDeclList, ConstDef ConstDef) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConstDeclListNext(\n");
