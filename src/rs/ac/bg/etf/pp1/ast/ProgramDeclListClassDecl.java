...
public class ProgramDeclListClassDecl extends ProgramDeclList {

    private ProgramDeclList ProgramDeclList;
    private ClassDecl ClassDecl;

    public ProgramDeclListClassDecl (ProgramDeclList ProgramDeclList, ClassDecl ClassDecl) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ProgramDeclListClassDecl(\n");
