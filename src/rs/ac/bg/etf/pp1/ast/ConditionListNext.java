...
public class ConditionListNext extends ConditionList {

    private ConditionList ConditionList;
    private CondTerm CondTerm;

    public ConditionListNext (ConditionList ConditionList, CondTerm CondTerm) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("ConditionListNext(\n");
